...
public class DSAproject1 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // tinitignan kung tama input ni user
            int choice = 0;
            try {
            ...
            switch (choice) {
                ...
                case 2:
                    if (sections.isEmpty()) {
                        System.out.println("No sections created yet. Please create a section first.");
                        break;
                    }
                    System.out.print("Enter Section Name: ");
                ...
                case 4:
                    ...
                    findStudentInSection(studentName);
                    break;
                case 5:
                    System.out.print("Enter Section Name: ");
                    sectionName = scanner.nextLine();
    ...
    private static void findStudentInSection(String studentName) {
        boolean found = false;
        for (Section section : sections) {
            Node current = head;
            while (current != null) {
                if (current.student != null && current.student.getName().equals(studentName)) {
                    System.out.println("Student '" + studentName + "' found in section '" + current.sectionName + "'.");
                    found = true;
                    break;
                }
                current = current.next;
        ...
        if (!found) {
            System.out.println("Student '" + studentName + "' not found in any section.");
        }
    }
